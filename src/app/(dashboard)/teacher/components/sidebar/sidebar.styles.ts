...
export const Overlay = tv({
  base: "bg-default-50 fixed inset-0 z-[201] opacity-80 transition-opacity md:hidden md:z-auto md:opacity-100",
});
...
export const Body = tv({
  base: "flex flex-col gap-6 mt-9 px-2 bg-default-50",
});
